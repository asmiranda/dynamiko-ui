class MyGoalWidget {
    ...
    loadTableData(val) {
        ...
        if (val == "") {
            ajaxRequestDTO.url = "/api/generic/" + storage.getCompanyCode() + "/widget/MyGoalWidget";
        }
        else {
            ajaxRequestDTO.url = "/api/generic/" + storage.getCompanyCode() + "/widget/MyGoalWidget/" + val;
        }
        ajaxRequestDTO.data = "";
