class MyP2P {
    ...
    setVideoAndScreenBitRate(sdp) {
        ...
        if (connArr.length <= 2) {
            ...
            newSdp = this.setMediaBitrate(newSdp, "video", 150)
            newSdp = this.setMediaBitrate(newSdp, "audio", 50)
        }
        else {
            newSdp = this.setMediaBitrate(newSdp, "video", 100)
            newSdp = this.setMediaBitrate(newSdp, "audio", 40)
        }
        return newSdp;
    }
