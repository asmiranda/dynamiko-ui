class GovernmentAccountingUI { 
    ...
    loadGovernmentAccountingProfile(obj, tabName) {
        ...
        var url = `${MAIN_URL}/api/generic/${sessionStorage.companyCode}/widget/GovernmentAccountingUI/getGovernmentAccountingProfile/${recordId}`;
    ...
    searchGovernmentAccountingFilter(obj) {
        ...
        var url = `${MAIN_URL}/api/generic/${sessionStorage.companyCode}/widget/GovernmentAccountingUI/filterGovernmentAccounting/${value}`;
        var ajaxRequestDTO = new AjaxRequestDTO(url, "");
